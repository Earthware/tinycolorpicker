...
(function($) {
    ...
    ,   defaults   = {
        ...
        ,   backgroundUrl : null, nocolorbackgroundUrl: 'images/no-color.png',
        nocolor: false
        }
    ;
    ...
    function Plugin($container, options) {
        ...
        function _initialize() {
            if(hasCanvas) {
                ...
                if(self.options.nocolor){
                    $nocolor = $("<div class='nocolor'>none</div>")
                    $track.append($nocolor);
                }
        ...
        this.setColor = function(color) {
            ...
            $color.find(".colorInner").css("background",""); // reset
            
            if(color === null){
                $color.find(".colorInner").css("background", "url(" + self.options.nocolorbackgroundUrl + ") no-repeat 50% 50%");
                self.colorHex = "#fff";
